...
a = Conv2D(filters = 10,kernel_size=(12,12), strides=(1,1),padding='valid',kernel_regularizer=regularizers.l2(1e-5)) (a)
...
mc = ModelCheckpoint('C:/data/lotte/h5/28_EfficientNetB4_.h5',save_best_only=True, verbose=1)
...
# predict
model.load_weights('C:/data/lotte/h5/28_EfficientNetB4_.h5')
result = model.predict(x_pred,verbose=True)

sub = pd.read_csv('C:/data/lotte/csv/sample.csv')
sub['prediction'] = np.argmax(result,axis = 1)
sub.to_csv('C:/data/lotte/csv/28.csv',index=False)
...
#     sub = pd.read_csv('C:/data/lotte/csv/sample.csv')
#     sub['prediction'] = np.argmax(result,axis = 1)
#     sub.to_csv('C:/data/lotte/csv/30_tta_i.csv',index=False)

# pred = np.mean(predictions, axis=0)

# sub = pd.read_csv('C:/data/lotte/csv/sample.csv')
# sub['prediction'] = np.argmax(result,axis = 1)
# sub.to_csv('C:/data/lotte/csv/30_tta.csv',index=False)
