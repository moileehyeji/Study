...
mc = ModelCheckpoint('C:/data/lotte/h5/20_EfficientNetB2.h5',save_best_only=True, verbose=1)
...
# predict
model.load_weights('C:/data/lotte/h5/20_EfficientNetB2.h5')
...
sub.to_csv('C:/data/lotte/csv/22_ttaXXXXX.csv',index=False)
...
for i in tqdm(range(tta_steps)):
    ...
    sub = pd.read_csv('C:/data/lotte/csv/sample.csv')
    sub['prediction'] = np.argmax(preds,axis = 1)
    sub.to_csv(f'C:/data/lotte/csv/22_ttaOOOOO{i}.csv',index=False)
...
sub.to_csv('C:/data/lotte/csv/22_ttaOOOOO.csv',index=False)
