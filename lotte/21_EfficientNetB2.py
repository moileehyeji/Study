...
mc = ModelCheckpoint('C:/Study/lotte/data/h5/21_EfficientNetB2.h5',save_best_only=True, verbose=1)
...
lr = ReduceLROnPlateau(patience= 13, factor=0.5)
...
# predict
model.load_weights('C:/Study/lotte/data/h5/21_EfficientNetB2.h5')
...
sub.to_csv('C:/Study/lotte/data/21.csv',index=False)
...
# Epoch 116/200
# 1200/1200 [==============================] - 187s 156ms/step - loss: 8.1407e-04 - acc: 0.9997 - val_loss: 0.0047 - val_acc: 0.9986

# Epoch 00116: val_loss did not improve from 0.00375
# 2250/2250 [==============================] - 66s 29ms/step
#==========================================
