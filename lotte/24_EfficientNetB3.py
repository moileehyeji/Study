import numpy as np
from tensorflow.keras.applications import EfficientNetB4, EfficientNetB2, EfficientNetB3
...
mc = ModelCheckpoint('C:/data/lotte/h5/24_EfficientNetB3.h5',save_best_only=True, verbose=1)
# efficientnet = EfficientNetB4(include_top=False,weights='imagenet',input_shape=x_train.shape[1:])
mobile = EfficientNetB3(include_top=False,weights='imagenet',input_shape=x_train.shape[1:])
...
# predict
model.load_weights('C:/data/lotte/h5/24_EfficientNetB3.h5')
...
sub.to_csv('C:/data/lotte/csv/24.csv',index=False)
...
#==========================================24 : 24_EfficientNetB3 : 76.165점
# Epoch 00075: val_loss did not improve from 0.00382
# Epoch 76/200
# 1200/1200 [==============================] - 381s 318ms/step - loss: 7.4545e-04 - acc: 0.9998 - val_loss: 0.0048 - val_acc: 0.9987

# Epoch 00076: val_loss did not improve from 0.00382
# 2250/2250 [==============================] - 179s 78ms/step
