...
mc = ModelCheckpoint('C:/Study/lotte/data/h5/13.h5',save_best_only=True, verbose=1)
...
# predict
model.load_weights('C:/Study/lotte/data/h5/13.h5')
...
sub.to_csv('C:/Study/lotte/data/13.csv',index=False)

#  optimizer=Adam(lr=1e-5) :  20등/72.531