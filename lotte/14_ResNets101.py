...
mc = ModelCheckpoint('C:/Study/lotte/data/h5/14_ResNets101.h5',save_best_only=True, verbose=1)
...
# predict
model.load_weights('C:/Study/lotte/data/h5/14_ResNets101.h5')
...
sub.to_csv('C:/Study/lotte/data/14.csv',index=False)
