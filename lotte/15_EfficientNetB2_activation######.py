...
mc = ModelCheckpoint('C:/Study/lotte/data/h5/15_EfficientNetB2_swish.h5',save_best_only=True, verbose=1)
...
# predict
model.load_weights('C:/Study/lotte/data/h5/15_EfficientNetB2_swish.h5')
...
sub.to_csv('C:/Study/lotte/data/15_swish.csv',index=False)
