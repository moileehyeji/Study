# 모델 저장
# 1. 모델구성 아래
# 2. 훈련 아래  --> 모델(model.save), 가중치(model.save_weights) 각각 저장
...
modelpath = '../data/modelcheckpoint/k52_1_mnist_{epoch:02d}_{val_loss:.4f}.hdf5'
...
'''
mnist_CNN : 
loss :  0.24505098164081573
acc :  0.9276000261306763
'''
