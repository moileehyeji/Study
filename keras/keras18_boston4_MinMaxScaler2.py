# keras18_boston3_MinMaxScaler1소스의 문제점 
# 전제 데이터 전처리시 과적합 문제 발생
# x_train(FIT,TRANSFORM), x_test, val,predict(TRANSFORM)하여 과적합 회피
# 데이터 전처리는 필수
...
EPOCHS = 200)
loss :  20.540470123291016
mae :  2.730053424835205
rmse :  4.532158932942944
r2 :  0.7542505055557457
EPOCHS = 500)
loss :  16.048477172851562
mae :  2.5015883445739746
rmse :  4.006054796666963
r2 :  0.8079934069534853    ---------------->Epochs가 크다고 좋은 것은 아니다. 훈련과정에서 loss값이 줄어들지 않음
