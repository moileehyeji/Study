...
def callbacks():
    modelpath ='../data/modelcheckpoint/k62_5_{epoch:2d}_{val_loss:.4f}.hdf5'
...
<tensorflow.python.keras.wrappers.scikit_learn.KerasClassifier object at 0x00000282815B3C70>
0.9930555621782938
최종스코어 :  0.9722222089767456
