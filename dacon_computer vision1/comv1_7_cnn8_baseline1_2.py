...
modelpath = './dacon/computer/modelcheckpoint/comv1_7_cnn8_baseline1_2_{epoch:02d}_{val_acc:.4f}.hdf5'
...
for i in opti:
    ...
    model.fit(train_generator, epochs=1000,validation_data=val_generator , callbacks=[early, lr, cp])
...
model.save('./dacon/computer/h5/comv1_7_cnn8_baseline1_2.h5')
