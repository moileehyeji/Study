...
# print("cumsum >= 0.97", cumsum >= 0.97) 
# print("d : ", d) # d :  194

pca = PCA(n_components=d)
train2 = pca.fit_transform(train2)
# print(x)
# print(x.shape) # (2048, 194)
...
print(train2.shape, test2.shape) # (2048, 194) (2048, 194)
...
for train_index, valid_index in skf.split(train2, t_d):
    ...
    model = Sequential()
    model.add(Conv2D(16,(3,3),activation='relu',input_shape=(97,2,1),padding='same'))
    ...
    mc = ModelCheckpoint('C:/data/modelCheckpoint/0202_1_{epoch:02d}_best_mc.h5',save_best_only=True, verbose=1)
    ...
    # predict
    # model.load_weights('C:/data/modelCheckpoint/0202_1_{epoch:02d}_best_mc.h5')
...
sub
sub.to_csv('C:/data/dacon_mnist/answer/0202_1_mnist.csv',index=False)