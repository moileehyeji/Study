...
# 3. 훈련
model.fit(x_train, y_train, verbose=1, eval_metric='mlogloss', eval_set=[(x_train, y_train),(x_test, y_test)])      # loss의 history반환
...
print('result : ', result)                  # {'validation_0': OrderedDict([('mlogloss'---'validation_1': OrderedDict([('mlogloss',



'''
< 다중분류의 eval_metric >
[eval_metric='mlogloss']    mlogloss    :  0.9722222222222222
[accuracy_score]            acc         :  0.9722222222222222
'''