...
#4. 평가, 예측
print('최적의 매개변수 : ', model.best_estimator_)      # 최적의 매개변수 :  RandomForestRegressor(max_depth=35, min_samples_leaf=4, min_samples_split=10, n_jobs=3)

y_pred = model.predict(x_test)
print('최종 정답률 : ', r2_score(y_test, y_pred))       # 최종 정답률 :  0.37948266914013495

aaa = model.score(x_test, y_test)   
print(aaa)                                             # 0.37948266914013495
