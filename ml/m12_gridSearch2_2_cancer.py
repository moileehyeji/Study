...
#4. 평가, 예측
print('최적의 매개변수 : ', model.best_estimator_)          # 최적의 매개변수 :  RandomForestClassifier(min_samples_split=3, n_estimators=200, n_jobs=4)

y_pred = model.predict(x_test)
print('최종 정답률 : ', accuracy_score(y_test, y_pred))     # 최종 정답률 :  0.9649122807017544

aaa = model.score(x_test, y_test)
print(aaa)                                                 # 0.9649122807017544


print(f"{finish_time - start_time:.2f}초 걸렸습니다")       # 78.81초 걸렸습니다
