...
#4. 예측, 평가
print("최적의 매개변수 : ", model.best_estimator_)          # 최적의 매개변수 :  RandomForestRegressor(max_depth=35, min_samples_leaf=5, min_samples_split=8, n_jobs=3)

y_pred = model.predict(x_test)
print("최종 정답률 : ", r2_score(y_test, y_pred))           # 최종 정답률 :  0.3944350572120543

print(f"{finish_time - start_time:.2f}초 걸렸습니다")       # 79.99 --> 11.45초 걸렸습니다
