...
def split_xy (data, time_steps, y_row):
    ...
    for i in range(len(data)):
        ...
        x_end_number = i + time_steps       # 7일차까지
        y_end_number = x_end_number         # 7일차에서 target1, 2
...
# print('x : ', X.shape)      # (52129, 336, 7)
# print('y1 : ', Y1.shape)    # (52129, 48)
# print('y2 : ', Y2.shape)    # (52129, 48)


# =====================================================================데이터 전처리
df_train = df_train.to_numpy()
x, y1, y2 = split_xy(df_train, 7*24*2, 24*2)
...
print(y1_train.shape)   # (33362, 48)
print(y1_test.shape)    # (10426, 48)
print(y1_val.shape)     # (8341, 48)
print(y2_train.shape)   # (33362, 48)
print(y2_test.shape)    # (10426, 48)
print(y2_val.shape)     # (8341, 48)
...
x_test = x_test.reshape(-1, 336, 7)
x_val = x_val.reshape(-1, 336, 7)
X_test = X_test.reshape(81, 336, 7)
...
submission.to_csv('./dacon/submission/unite_submission.csv', index=True, encoding='cp949')