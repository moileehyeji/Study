...
# print(x_train.shape)    #(33576, 8)
# print(x_test.shape)     #(10493, 8)
# print(x_val.shape)      #(8395, 8)
...
for q in quantiles : 
        ...
        submission.to_csv(f'./dacon/submission/submission0125_addmodel_quantile/submission_7_1_{q}.csv', index = False)  
...
# to csv
submission.to_csv('./dacon/submission/submission0125_addmodel_quantile/submission_7_2.csv', index = False)  # score :1.9498123625
...
2)  lr : 0.1, fac : 0.5 / lr : 0.09, fac : 0.5 
'''