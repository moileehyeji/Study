...
for q in quantiles : 
    ...
    #3. 컴파일, 훈련
    path = './dacon/modelcheckpoint/0124_6_0.7/dacon_Dense_{val_loss:.4f}.hdf5'
    ...
    model.fit(x_train, y_train, epochs=1000, batch_size=62, callbacks=[er, re, mo], validation_data=(x_val, y_val), verbose=1)

    model.save('./dacon/h5/0124_6_0.7/dacon6_2_unite_0.7.h5')
...
# to csv
submission.to_csv('./dacon/submission/submission0124_6_0.7/submission_6_2.csv', index = False)  # score :1.93339
