...
# model.fit(x_train, y_train, epochs=100, batch_size=BS, callbacks=[er, lr], validation_data=(x_val, y_val))
...
# 적용해볼 이미지 
test_image = './project/data/test5.jpg'
# 이미지 resize
...
# New data category :  pullupbars

# New data category :  runningmachine
