...
for q in quantiles : 
        ...
        submission.to_csv(f'./dacon/submission/submission0123_0.4/submission_0123_1_{q}.csv', index = False)  
...
# to csv
submission.to_csv('./dacon/submission/submission0123_0.4/submission_0123_2.csv', index = False)  # score :2.02021
...
submission.to_csv('./dacon/submission/unite_submission_30minute_analysis2.csv', index=False, encoding='cp949')
